...
const Punishments = () => {
  ...
  const punishments = [
    {
      title: 'The Billboard of Shame',
      description: 'Must put up a billboard in their hometown advertising their fantasy football failure'
    },
    {
      title: 'The Pink Jersey',
      description: 'Must wear a pink jersey to all public events for one month'
    },
    {
      title: 'Social Media Takeover',
      description: 'League members control their social media for one week'
    },
    {
      title: 'The Waffle House Challenge',
      description: 'Must stay at Waffle House until they\'ve eaten one waffle for every loss'
    },
    {
      title: 'Stand-up Comedy Night',
      description: 'Must perform a 5-minute stand-up routine about their fantasy failures at a local comedy club'
    },
    {
      title: 'The Calendar Shoot',
      description: 'Must participate in an embarrassing calendar photoshoot with proceeds going to charity'
    }
  ];
  ...
  const pastSackos = [
    { year: 2024, team: 'Grid Iron Giants', punishment: 'The Billboard of Shame' },
    { year: 2023, team: 'Fantasy Falcons', punishment: 'Pink Jersey Month' },
    { year: 2022, team: 'End Zone Eagles', punishment: 'Social Media Takeover' },
    { year: 2021, team: 'Pigskin Pirates', punishment: 'Waffle House Challenge' },
  ];
